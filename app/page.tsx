      ...
      <section className="relative min-h-screen flex items-center px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4 max-w-lg">
                <p className="text-base text-gray-700 leading-relaxed">
                  ZISARKNAR — SOFTWARE ENGINEER, I&apos;M SPECIALIZES IN WEBSITE DESIGN, PROTOTYPING, WIRE-FRAMING, AND DESIGN SYSTEMS, TURNING COMPLEX IDEAS INTO CLEAN, FUNCTIONAL INTERFACES DESIGN.
                </p>
              </div>
            ...
            {/* Right Content - Placeholder for image/visual */}
            <div className="relative lg:flex hidden items-center justify-center">
              <div className="relative">
                {/* Decorative elements */}
                <div className="absolute -top-12 -left-12 w-24 h-24 border-t-2 border-l-2 border-gray-200"></div>
                <div className="absolute -bottom-12 -right-12 w-24 h-24 border-b-2 border-r-2 border-gray-200"></div>
                
                {/* Japanese text */}
                <div className="flex items-center justify-center">
                  <span className="text-8xl font-light text-gray-100 tracking-wider">
                    東京
                  </span>
                </div>
              </div>
        ...
        <div className="absolute bottom-8 left-0 right-0 px-6 md:px-12 lg:px-24">
          <div className="max-w-7xl mx-auto text-center">
            <Link href="/about" className="text-xs text-gray-500 hover:text-gray-900 transition-colors tracking-wider">ABOUT</Link>
          </div>
        </div>
      </section>
